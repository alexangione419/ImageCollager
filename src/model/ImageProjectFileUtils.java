...
public final class ImageProjectFileUtils {
  ...
  /**
   * Returns whether a file name is valid. A valid file name is a String that is not null, is not
   * just whitespace, and it does NOT contain a ".".
   *
  ...
  /**
   * Returns whether the file at the given file path is a project file. A project file is a file
   * with the file extension ".collage".
   *
