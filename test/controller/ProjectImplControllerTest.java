...
public class ProjectImplControllerTest {
  ...
  public void help() {
    ...
    assertEquals("Awaiting command:\nHere are all the available commands:\n"
            ...
            + "add-image-to-layer: adds an image at the given file path to the layer on the current project that matches the same name.set-filter: sets a filter for a specified layer.\n"
